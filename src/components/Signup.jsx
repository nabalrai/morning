...
function Signup() {
  ...
  const signupUser = async (e) => {
    e.preventDefault();
    //COMMENT: these is the appwrite method nothing more complicated
    const promise = account.create(
      uuidv4(),
      user.email,
      user.password,
      user.name
    ); //these much code is responisble for creating a new account/user
    promise.then(
      function (response) {
  ...
  return (
    <section className=" loginSignupBackground">
      <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-12 lg:px-8 lg:py-10">
